...
class UploadHandler
{
 ...
 //           'upload_dir' => preg_replace('/\/Scripts_Fonctions\/.+$/', '', getcwd()).'/'.$_SESSION['chemin_slider_imgs'],
            'upload_dir' => $_SESSION['chemin_slider_imgs'],
            'upload_url' => 'http://sliders.oto-web.fr/'.preg_replace('/^(\.\.\/)+/', '', $_SESSION['chemin_slider_imgs']),
